...
public class SwiftCodeDTO {
    ...
    @JsonProperty("CONNECTED_TO_SWIFT")
    private String CONNECTED_TO_SWIFT;

    @JsonProperty("SWIFT_CONNECTION")
	...
	public SwiftCodeDTO(int iD, String bANK_TYPE, String sWIFT_CODE, String cONNECTED_TO_SWIFT, String sWIFT_CONNECTION,
			String bANK_NAME, String bRANCH, String aDDRESS_1, String aDDRESS_2, String aDDRESS_3, String aDDRESS_4,
			String cITY, String cOUNTRY_CODE, int pARA_STATUS, int aCTIVE_STATUS, String jSON_DATA) {
		super();
		ID = iD;
		BANK_TYPE = bANK_TYPE;
